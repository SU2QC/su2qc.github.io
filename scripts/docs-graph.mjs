...
const exclusions = {
  ...
  "docs/BACKUP_MANIFEST_v2.0.0.json": "Machine-readable backup manifest is validated separately; Graphify 0.9.45 produces no source node for this JSON artifact.",
