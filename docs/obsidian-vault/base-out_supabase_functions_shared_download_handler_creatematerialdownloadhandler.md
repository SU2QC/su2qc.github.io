---
graphify_id: base-out::supabase_functions_shared_download_handler_creatematerialdownloadhandler
source_file: supabase/functions/_shared/download-handler.js
node_type: code
tags: [su2qc, graphify]
---

# createMaterialDownloadHandler()

Purpose: Graphify extracted this code from the repository.

Graphify node ID: `base-out::supabase_functions_shared_download_handler_creatematerialdownloadhandler`
