---
graphify_id: base-out::next_config
source_file: next.config.mjs
node_type: code
tags: [su2qc, graphify]
---
...
Graphify node ID: `base-out::next_config`
Repository source: `next.config.mjs`
Node type: `code`
...
- [[base-out_next_config_nextconfig]]
