---
graphify_id: base-out::public_images_investigators_raza-sabbir-sufian
source_file: public/images/investigators/raza-sabbir-sufian.png
node_type: image
tags: [su2qc, graphify]
---

# Raza-Sabbir-Sufian Investigator Photo

Purpose: Graphify extracted this image from the repository.

Graphify node ID: `base-out::public_images_investigators_raza-sabbir-sufian`
